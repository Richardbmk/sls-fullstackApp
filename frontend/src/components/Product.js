...
export default class ProductAdmin extends Component {
    ...
    state = {
        isEditMode: false,
        updateproductname: this.props.name
    }
    ...
    handleEditSave = event => {
        ...
        this.props.handleUpdateProduct(this.props.id, this.state.updateproductname);
    }
    ...
    render() {
        return (
            <div className="tile ischild box notification is-success">
                {
                    this.props.isAdmin &&
                    <Fragment>
                ...
                }
                {
                    ...
                    <div>
                        ...
                        <p className="product-title">id: { this.props.id }</p>
                    </div>
                }
            </div>
        )
